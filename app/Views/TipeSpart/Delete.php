    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>Hapus Jenis Sparepart</h4>
            </div>

            <div class="col-lg-12 card-body card-form__body">
                <form action="<?= base_url() . '/TipeSpart/deleteconfirmed/' . $TipeSpart['id_jenis_spart'] ?>" method="POST">


                    <div class="form-group">
                        <label for="email">Nama Jenis SparePart</label>
                        <p><?= $TipeSpart['nama_jenis_spart']; ?></p>
                    </div>


                    <div class="form-group" style="margin-top:75px;">
                        <div class="alert alert-warning">
                            Peringatan! Tipe Sparepart yang dipilih akan Dihapus
                        </div>
                    </div>
